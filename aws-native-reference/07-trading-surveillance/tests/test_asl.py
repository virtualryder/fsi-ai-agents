import json, os
ASL = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "stepfunctions", "trading_surveillance.asl.json")
...
def test_hitl_waitfortasktoken():
    g=_load()["States"]["ComplianceReviewGate"]
