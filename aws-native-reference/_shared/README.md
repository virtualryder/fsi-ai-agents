...
| **Native rebuild** (all 12 agents) | deterministic core in Lambdas + Strands drafting + Step Functions HITL | when you want managed orchestration, durable `waitForTaskToken` HITL, per-node scaling |
