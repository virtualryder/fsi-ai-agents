...
def init_session_state():
    ...
    defaults = {
        ...
        "openai_key_configured": bool(os.getenv("ANTHROPIC_API_KEY")),
    }
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        systems = [
            ...
            ("OpenAI Claude Sonnet 4.6", st.session_state.openai_key_configured, "LIVE" if st.session_state.openai_key_configured else "KEY NEEDED"),
            ("Case Mgmt", True, "MOCK"),
        ]
...
NOTE: This is an AI-generated draft. BSA Officer must review and complete before filing.""",
        ...
        "audit_trail": [
            ...
            {"timestamp": now.isoformat(), "actor": "ai_agent", "action": "Risk score: 74.5/100 — FILE_SAR recommended", "node": "risk_scoring", "ai_model_used": "claude-sonnet-4-6"},
...
def render_sar_draft():
    ...
    st.markdown("""
    <div class="compliance-disclaimer">
    This SAR draft was generated by AI (Claude Sonnet 4.6) and requires BSA Officer review before filing.
